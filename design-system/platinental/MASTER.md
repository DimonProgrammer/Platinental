...
> ⚠️ **DEPRECATED** — содержит устаревшую палитру и типографику (включая Orbitron и киберпанк-цвета), которые **противоречат** финализированной дизайн-системе.
>
> **Источник правды:** [`docs/design-research/00-synthesis-v2.md`](../../docs/design-research/00-synthesis-v2.md) и [`DESIGN.md`](../../DESIGN.md).
> Pattern library с кодом: [`docs/design-research/02-patterns/`](../../docs/design-research/02-patterns/).
> Токены: [`src/styles/tokens.css`](../../src/styles/tokens.css).
>
> Этот файл сохранён только для истории. **Не применять.**

---

> **LOGIC (УСТАРЕЛО):** When building a specific page, first check `design-system/pages/[page-name].md`.
