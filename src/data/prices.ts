...
const face: PriceGroup[] = [
  {
    ...
    rows: [
      { service: 'Блефаропластика верхних век', code: 'A16.26.111', price: 'от 100 000 ₽' },
      { service: 'Блефаропластика нижних век', code: 'A16.26.111', price: 'от 100 000 ₽' },
      { service: 'Блефаропластика «ПИНЧ»-метод', code: 'A16.26.111', price: 'от 65 000 ₽' },
      { service: 'Удаление грыжи верхнего/нижнего века', code: 'A16.26.111', price: 'от 65 000 ₽' },
      { service: 'Круговая блефаропластика с подтяжкой средней зоны', code: 'A16.26.111', price: 'от 325 000 ₽' },
  ...
  },
  {
    title: 'Ринопластика',
    rows: [
      { service: 'Ультразвуковая ринопластика', code: 'A16.08.008', price: 'от 303 000 ₽' },
      { service: 'Ультразвуковая риносептопластика', code: 'A16.08.008', price: 'от 353 000 ₽' },
      { service: 'Вторичная риносептопластика', code: 'A16.08.008', price: 'от 400 000 ₽' },
      { service: 'Ультразвуковая ринопластика (Мамедов В.А.)', code: 'A16.08.008', price: 'от 1 000 000 ₽' },
      { service: 'Вторичная ультразвуковая ринопластика (Мамедов В.А.)', code: 'A16.08.008', price: 'от 1 200 000 ₽' },
      { service: 'Пластика кончика носа', code: 'A16.08.008', price: 'от 203 000 ₽' },
      { service: 'Пластика колумеллы', code: 'A16.08.008', price: 'от 31 500 ₽' },
    ],
  },
  {
    title: 'Подтяжка лица',
    rows: [
      { service: 'Круговая подтяжка лица и шеи (SMAS)', code: 'A16.07.022', price: 'от 535 000 ₽' },
      { service: 'Лифтинг верхней трети', code: 'A16.25.024', price: 'от 265 000 ₽' },
      { service: 'Темпоропластика', code: 'A16.25.024', price: 'от 325 000 ₽' },
  ...
  },
  {
    ...
    rows: [
      { service: 'Гениопластика (Мамедов В.А.)', code: 'A16.07.022', price: 'от 700 000 ₽' },
      { service: 'Гениопластика (Сорвин В.А.)', code: 'A16.07.022', price: 'от 550 000 ₽' },
      { service: 'Удаление комков Биша', code: 'A16.07.022', price: 'от 130 000 ₽' },
      { service: 'Отопластика', code: 'A16.07.022', price: 'от 126 000 ₽' },
      { service: 'Пластика мочек уха', code: 'A16.07.022', price: 'от 80 000 ₽' },
      { service: 'Ментопластика (с использованием импланта)', code: 'A16.07.022', price: 'от 420 000 ₽' },
      { service: 'Булхорн', code: 'A16.07.022', price: 'от 150 000 ₽' },
...
const body: PriceGroup[] = [
  {
    title: 'Маммопластика',
    rows: [
      { service: 'Маммопластика (увеличение груди)', code: 'A16.20.086', price: 'от 472 000 ₽' },
      { service: 'Мастопексия (подтяжка груди)', code: 'A16.20.085', price: 'от 472 000 ₽' },
      { service: 'Мамморедукция с подтяжкой', code: 'A16.20.085', price: 'от 480 000 ₽' },
      { service: 'Ареолярная подтяжка', code: 'A16.20.085', price: 'от 250 000 ₽' },
      { service: 'Гинекомастия', code: 'A16.07.022', price: 'от 150 000 ₽' },
      { service: 'Удаление имплантов', code: 'A16.30.026', price: 'от 262 000 ₽' },
  ...
  },
  {
    ...
    rows: [
      { service: 'Миниабдоминопластика', code: 'A16.01.034', price: 'от 250 000 ₽' },
      { service: 'Абдоминопластика', code: 'A16.01.034', price: 'от 262 000 ₽' },
...
export const doctorPriceSheets: DoctorPriceSheet[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { procedure: 'Вторичная ультразвуковая ринопластика', price: 'от 1 200 000 ₽' },
    ],
  },
  {
    doctorSlug: 'sorvin',
    ...
    items: [
      ...
      { procedure: 'Ортогнатия', price: 'от 1 200 000 ₽' },
