...
### P1. Max ведёт на общий адрес

**Status 18.05.2026:** закрыто. Клиент передал актуальную ссылку профиля Max, публичные CTA заменены.
...
**Fix:** По решению пользователя Max оставлен в наборах каналов связи, общий адрес заменён на актуальный профиль.
...
- [x] Заменить Max-ссылку на реальный чат после подтверждения клиента.
